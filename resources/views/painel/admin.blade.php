...
<body class="skin-black layout-top-nav">
    <div class="wrapper">
        ...
        <!-- Full Width Column -->
        <div class="content-wrapper" style="background-image: url('{{ url('bg2.jpg') }}');
                ...
                <nav style="background-color: transparent;border-color:transparent"
                    ...
                    <div style="background-color: transparent;border-color:transparent" class="container text-center">
                        ...
                        <div style="border-color: transparent" class="navbar-header text-center">
                            ...
                            <a style="margin-right: 90px" class="navbar-brand" href="{{ url('/') }}"><img
                                    width="145px" src="{{ asset('logo4.png') }}" alt=""></a>
                        </div>
                                    ...
                                    <center>
                                        <ul style="background-color: transparent;border-color:transparent"
                                            ...
                                            <a style="margin-bottom: 8px" href="{{ url('ships') }}"
                                                class="btn" href="">Spaceships</a>
                                            <a style="margin-bottom: 8px" class="btn"
                                                href="{{ url('rewards') }}">Rewards</a>
                                            <a style="margin-bottom: 8px" class="btn"
                                                href="{{ url('player/bonus') }}">Bonus</a>
                                            <a style="margin-bottom: 8px" class="btn"
                                                href="{{ url('player') }}">Players</a>
                                        </ul>
                                    </center>
                            ...
                            @if (Auth::user()->tipo != 1)
                                ...
                                @else
                                    <a href="{{ url('admin/dashboard') }}" class="navbar-brand"
                                        style="margin-top: -10px"><img width="156px" src="{{ url('logo4.png') }}"
                                            alt="">
                            @endif
                            <br>
                            </a>
...
z-index:1000;">
    ...
    <script>
        $(document).ready(function() {
            element.classList.remove("goog-te-banner-frame");
