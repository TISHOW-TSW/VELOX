        ...
        <div class="row">
            <div class="col-lg-8">
                <div style="background-color: transparent" class="panel ">
                    <div class="panel-heading">Cadastrar foto Plano</div>
                    <div class="panel-body text-center">
                        @if (isset($produto->img))
                            <img width="20%" src="{{ url('arquivos/planos', $produto->img) }}" alt="">
                            <br>

                        @else
                        @endif
                        <form method="post" action="{{ url('api/file-upload/plano/upload') }}"
