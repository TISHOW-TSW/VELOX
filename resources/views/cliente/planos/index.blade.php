        ...
        <div class="container">
            ...
            @forelse ($planos as $plano)
                <div style="margin-top:30px" class="col- col-md-3">
                    <div id="selecionado{{ $plano->id }}" class="panel borda insta">
                        <div class="panel-body outro text-center">
                            <h2 style="color: white" class="panel-title text-center">{{ $plano->name }}</h2>
                            ...
                            <center>
                                ...
                                <img @if ($busca = App\Models\Compra::where('user_id', Auth::user()->id)->where('plano_id', $plano->id)->first()) @if ($busca->campanha() != 0)
                                style="filter: grayscale(100%);" @endif
                                @else @endif
                                width="90%" class="img img-responsive nave"
